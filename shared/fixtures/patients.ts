    ...
    entry: [
      ...
      },
      {
        resource: {
          ...
          status: 'final',
          code: {
            coding: [{ system: 'https://loinc.org', code: '4548-4', display: 'Hemoglobin A1c' }],
          },
          subject: { reference: `Patient/${patientId}` },
          valueQuantity: { value: 8.2, unit: '%', system: 'https://unitsofmeasure.org', code: '%' },
      ...
      },
      {
        resource: {
          ...
          status: 'final',
          code: {
            coding: [{ system: 'https://loinc.org', code: '33914-3', display: 'eGFR' }],
          },
          subject: { reference: `Patient/${patientId}` },
          valueQuantity: { value: 45, unit: 'mL/min/1.73m2', system: 'https://unitsofmeasure.org', code: 'mL/min/1.73m2' },
          effectiveDateTime: '2026-03-01T10:00:00Z',
        },
      },
      {
        resource: {
          ...
          clinicalStatus: { coding: [{ system: 'https://terminology.hl7.org/CodeSystem/condition-clinical', code: 'active' }] },
          code: { coding: [{ system: 'https://hl7.org/fhir/sid/icd-10-cm', code: 'E11.9', display: 'Type 2 diabetes mellitus' }] },
          subject: { reference: `Patient/${patientId}` },
        },
      },
    ],
