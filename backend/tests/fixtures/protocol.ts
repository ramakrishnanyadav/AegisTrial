/**
 * protocol.ts — Synthetic Clinical Protocol Fixture for AegisTrial tests & attacks.
 * Represents a Phase 3 Type 2 Diabetes & Chronic Kidney Disease Trial protocol.
 */

import { Protocol } from '../../src/domain/types.js';
